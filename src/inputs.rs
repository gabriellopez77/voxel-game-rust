...
impl Keys {
    pub const LAST_KEY: Keys = Keys::Menu;
}
...
pub fn set_key_state(key: i32, state: bool) { unsafe { KEYS[key as usize] = state } }
...
pub fn set_mouse_button_state(button: i32, state: bool) { unsafe { KEYS[button as usize] = state } }